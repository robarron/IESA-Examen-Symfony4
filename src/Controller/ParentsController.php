...
class ParentsController extends Controller
{
    ...
    {
        return $this->render('parents/index.html.twig', ['parents' => $parentsRepository->findAll()]);
    }
    ...
    {
        return $this->render('parents/show.html.twig', ['parent' => $parent]);
    }
    ...
    public function edit(Request $request, Parents $parent): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('parents_edit', ['id' => $parent->getId()]);
        }
